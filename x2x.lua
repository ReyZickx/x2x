if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("x2x is already running!", 0)
    return
end
...
if not game:IsLoaded() then
    ...
    notLoaded.Text = "x2x is waiting for the game to load"
    game.Loaded:Wait()
    notLoaded:Destroy()
end
...
Holder.Active = true
Holder.BackgroundColor3 = Color3.fromRGB(36, 26, 57)
...
Title.Parent = Holder
Title.Active = true
Title.BackgroundColor3 = Color3.fromRGB(36,26,37)
Title.BorderSizePixel = 0
Title.Size = UDim2.new(0, 250, 0, 20)
Title.Font = Enum.Font.SourceSans
Title.TextSize = 18
Title.Text = "x2x FE" .. currentVersion
...
CMDsF.ScrollBarImageColor3 = Color3.fromRGB(68,58,49)
CMDsF.BottomImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
CMDsF.CanvasSize = UDim2.new(0, 0, 0, 0)
CMDsF.MidImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
CMDsF.ScrollBarThickness = 7
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Unstable Device", "On mobile, x2x may have issues or features that are not functioning correctly.") end
end)